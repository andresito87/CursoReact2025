...
export const InstagromApp = () => {
    ...
    // es como un observe, isPending es true mientras de ejecuta startTransition
    ...
    const handleAddComment = async (formData: FormData) => {
        ...
        addOptimisticComment(messageText); // asumimos que la petición se resuelve correctamente

        // Toda la ejecución de este bloque no bloquea la UI
        startTransition(async () => {
            // Simular la petición http al servidor
            await new Promise((resolve) => setTimeout(resolve, 3000));

            // hecho de forma directa, useState, sin posibilidad de informar ni revertir los cambios
            // setComments((prev) => [
            //     ...prev,
            //     {
            //         id: new Date().getTime(),
            ...
            // Simulamos el error en la petición de agregar un comentario, así vemos que la UI es capaz de recuperarse
            // y mantenemos al usuario informado de una manera optimista, es decir, asuminendo que todo irá bien
            //! Ejecución de código necesario para revertir los cambios
